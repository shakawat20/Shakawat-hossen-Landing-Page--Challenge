...
const Products = ({ handleBadge }) => {
    ...
    return (
        <div id='products' style={{display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center",}}>
            <h1 style={{
                styleName: "Heading",
                fontWeight: 700,
                fontSize: "38px",
            ...
            <div className='grid  gap-24 items-center lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 '>
                {
